...
if (Array.isArray(nodes)) {
  // Initialize lavacord manager with the correct client and nodes
  lavalinkManager = new Manager(client, nodes);
} else {
  console.error("Lavalink nodes must be an array.");
  process.exit(1); // Exit the program if nodes isn't an array
}
